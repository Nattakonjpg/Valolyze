...
best_checkpoint_path = r'/home/thanapat_window/codes/Valolyze/A5_yoru+habor_Checkpoint_epoch_round112.pth'
...
inputVideo = r"/home/thanapat_window/codes/Valolyze/Backend/video_data/test_videofull/agent/round/รอบ 1.mp4"
# ระบุ path ที่ต้องการบันทึกไฟล์ผลลัพธ์
outputFolderVideo = r"/home/thanapat_window/codes/Valolyze/Backend/video_data/test_cutvideo/agent/round/test/"
# ระบุความยาวของคลิปวิดีโอที่ต้องการตัด (วินาที)
clipDuration = 2
# ระบุ path ที่ต้องการบันทึกไฟล์ CSV
output_csv = r"/home/thanapat_window/codes/Valolyze/Backend/Output/Time/agent/round1.csv"
...
output_file_text = r"/home/thanapat_window/codes/Valolyze/Backend/test_train_splits/agent/round/test_test_split1.txt"

create_test_split(outputFolderVideo, output_file_text)

data_dir = r"/home/thanapat_window/codes/Valolyze/Backend/video_data/test_cutvideo/agent/round/"
split_dir = r"/home/thanapat_window/codes/Valolyze/Backend/test_train_splits/agent/round/"
test_loader_A5 = prepare_hmdb51_test_loader(data_dir, split_dir)
print(test_loader_A5.dataset)

# ระบุเส้นทางที่จะบันทึกผลลัพธ์
output_path = r"/home/thanapat_window/codes/Valolyze/Backend/Output/Predict/agent/Round1.csv"
# เรียกใช้ฟังก์ชัน
evaluate_model(loaded_model, test_loader_A5, output_path)

path1 = output_path
path2 = output_csv
path3 = r"/home/thanapat_window/codes/Valolyze/Backend/Output/Final/FinalPredict+time_Round_1.csv"
